...
<?php if($view_mode == 'teaser'): ?>
  <div class="article-view-mode-teaser node-view-mode-teaser clearfix">
    ...
    <div class="article-view-mode-teaser-content node-view-mode-teaser-content">
      ...
      <p class="date"><?php print format_date($created, 'cu_medium_date'); ?></p>
...
<?php elseif($view_mode == 'title'): ?>
  <div class="article-view-mode-title node-view-mode-title clearfix">
    <div class="article-view-mode-titles-content node-view-mode-titles-content">
      <a href="<?php print $node_url; ?>"><?php print $title; ?></a>
    </div>
  </div>
